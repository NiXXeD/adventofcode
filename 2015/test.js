...
describe('advent of code 2015', () => {
    ...
    function test(day, part, expected) {
        const actual = run(2015, day, part, false)
    ...
    it('day 21, part 1', () => test(21, 1, 111))
    it('day 21, part 2', () => test(21, 2, 188))
    it('day 22, part 1', () => test(22, 1, 953))
    it('day 22, part 2', () => test(22, 2, 1289))
    it('day 23, part 1', () => test(23, 1, 255))
    it('day 23, part 2', () => test(23, 2, 334))
    it('day 24, part 1', () => test(24, 1, 11266889531))
    it('day 24, part 2', () => test(24, 2, 77387711))
    it('day 25, part 1', () => test(25, 1, 8997277))
})
